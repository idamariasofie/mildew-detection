...
def page_findings_body():
    st.title("Findings")
    st.write("This page shows the findings of the project.")
    st.info(
    ...
    if st.checkbox("Difference between average and variability image"):
      ...
      avg_healthy_powdery = plt.imread("/workspace/mildew-detection/outputs/avg_diff.png")
      ...
      st.image(avg_healthy_powdery, caption='Average healthy and powdery mildew - Average and Variability')
      st.write("---")
