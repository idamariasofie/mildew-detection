...
def page_ml_metrics_body():
    ...
    labels_distribution = plt.imread("/workspace/mildew-detection/outputs/v5/datasets_distribution.png")
    ...
    with col1: 
        model_acc = plt.imread("/workspace/mildew-detection/outputs/v5/model_training_acc.png")
        st.image(model_acc, caption='Model Training Accuracy')
    with col2:
        model_loss = plt.imread("/workspace/mildew-detection/outputs/v5/model_training_losses.png")
